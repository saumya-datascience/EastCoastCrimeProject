...
// here the sunburst will be drawn for the first time
...
// sunburst will then be drawn for the value change from dropdown year
...
// function to initilize the map and tile layer
function init_map() {
    myMap = L.map("map", {
...
// function to get the new data and then plot on already initiale map
